import { Tier } from "@features/skytrainTrip/SkytrainData";

// Format for rewards in the trip's drop table where id is character id, and weight is probability weight
