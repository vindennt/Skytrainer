...
export const CommercialBroadway: Station = newStation("006", "00", false);
...
export const VCCClark: Station = newStation("025", "01", true);
export const Renfrew: Station = newStation("026", "01", true);
export const Rupert: Station = newStation("027", "01", true);
export const Gilmore: Station = newStation("028", "01", true);
export const Brentwood: Station = newStation("029", "01", true);
export const Holdom: Station = newStation("030", "01", true);
export const SperlingBurnabyLake: Station = newStation("031", "01", true);
export const LakeCity: Station = newStation("032", "01", true);
export const Burquitlam: Station = newStation("033", "03", true);
export const MoodyCentre: Station = newStation("034", "03", true);
export const InletCentre: Station = newStation("035", "03", true);
export const CoquitlamCentral: Station = newStation("036", "03", true);
export const Lincoln: Station = newStation("037", "03", true);
export const LafargeLakeDouglas: Station = newStation("038", "03", true);
export const VancouverCityCentre: Station = newStation("039", "02", true);
export const YaletownRoundhouse: Station = newStation("040", "02", true);
export const OlympicVillage: Station = newStation("041", "02", true);
export const BroadwayCityHall: Station = newStation("042", "02", true);
export const KingEdward: Station = newStation("043", "02", true);
export const OakridgeFourtyFirstAve: Station = newStation("044", "02", true);
export const LangaraFourtyNinthAve: Station = newStation("045", "02", true);
export const MarineDrive: Station = newStation("046", "02", true);
export const Bridgeport: Station = newStation("047", "02", true);
export const Aberdeen: Station = newStation("048", "02", true);
export const Lansdowne: Station = newStation("049", "02", true);
export const RichmondBrighouse: Station = newStation("050", "02", true);
export const Templeton: Station = newStation("051", "02", true);
export const SeaIslandCentre: Station = newStation("052", "02", true);
export const YVRAirport: Station = newStation("053", "02", true);
